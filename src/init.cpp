    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Suncoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  suncoind [options]                     " + "\n" +
                  "  suncoind [options] <command> [params]  " + _("Send command to -server or suncoind") + "\n" +
                  "  suncoind [options] help                " + _("List commands") + "\n" +
                  "  suncoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: suncoind.pid)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Suncoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Suncoin is probably already running."), strDataDir.c_str()));
